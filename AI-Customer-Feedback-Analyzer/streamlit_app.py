...
st.markdown("Upload a CSV with columns: `customer_id`, `feedback` or use the sample included.")
...
if uploaded_file is not None:
    ...
    st.dataframe(df[['customer_id','cleaned_feedback']].head())
    ...
    st.write(df[['customer_id','feedback','sentiment']].head(20))
    ...
    st.dataframe(df[['customer_id','short_summary']].head())
